        ...
        if(cqChecked){
            ...
            selectedQuestions.forEach((questionObj, index) => {
                questionPaper.innerHTML += `
                            <div class="final">
                            <div class="interFinal">
                                <span style="padding-right: 2px;">${banglaNumbers[index + 1]}.</span>
                                <span>${questionObj.image ? `<img src="${questionObj.image}" style="max-width: 100px; height: auto;"><br>` : ''}${questionObj.question}</span>
                            </div>
                            <div class="marks-section">
                                <p>${banglaNumbers[questionObj.marks]}</p>
                            </div>
                            </div>`;
                });
        }
